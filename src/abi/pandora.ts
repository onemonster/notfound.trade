export const PANDORA_ADDRESS = '0x9E9FbDE7C7a83c43913BddC8779158F1368F0413'
export const PANDORA_ABI = [{
  ...
  'inputs': [{ 'internalType': 'string', 'name': '_name', 'type': 'string' }, {
    ...
    'name': '_symbol',
    'type': 'string',
  }], 'name': 'setNameSymbol', 'outputs': [], 'stateMutability': 'nonpayable', 'type': 'function',
}, {
